...
const projects: Project[] = [
  {
    ...
    description: "Conception e-learning structurée avec progression pédagogique et évaluation continue.",
    image: "https://images.unsplash.com/photo-1513258496099-48168024aec0?auto=format&fit=crop&w=1080&q=80",
    tags: ["CoI", "ADDIE", "Bloom", " Terminé"],
    category: "Conception e-learning",
    color: "blue",
    emoji: "",
    details: {
      overview: "Module e-learning complet orienté apprentissage actif et autonomie.",
      features: [
      ...
      challenges: ["Engagement en asynchrone", "Cohérence objectifs-activités-évaluation"],
      outcome: " Terminé",
    },
  },
  {
    title: "02 — Serious Game VR",
    description: "Simulation de matériels en environnement immersif VR.",
    image: "https://images.unsplash.com/photo-1622979135225-d2ba269cf1ac?auto=format&fit=crop&w=1080&q=80",
    tags: ["Kolb", "Simulation", "VR", " Terminé"],
    category: "Simulation matériels",
    color: "purple",
    emoji: "🕶️",
    details: {
      overview: "Serious game immersif pour entraîner les apprenants en contexte proche du réel.",
      features: [
      ...
      architecture: ["Kolb", "Simulation", "VR"],
      challenges: ["Équilibre réalisme/clarte", "Charge cognitive"],
      outcome: " Terminé",
    },
  },
  {
    title: "03 — Mini-leçon Interactive",
    description: "Conception pédagogique interactive orientée STEM.",
    image: "https://images.unsplash.com/photo-1529078155058-5d716f45d604?auto=format&fit=crop&w=1080&q=80",
    tags: ["Constructivisme", "Gamification", "STEM", " Terminé"],
    category: "Conception pédagogique",
    color: "green",
    emoji: "",
    details: {
      overview: "Mini-leçon interactive construite pour favoriser exploration, pratique et consolidation.",
      features: [
        "Parcours court et engageant",
        "Activités interactives",
        "Éléments de gamification",
        "Évaluation formative",
      ],
      architecture: ["Constructivisme", "Gamification", "STEM"],
      challenges: ["Maintien de l'attention", "Progressivité des notions"],
      outcome: " Terminé",
    },
  },
  {
    title: "04 — Capsule Vidéo Interactive",
    description: "Capsule pédagogique autour de l'analyse ergonomique du travail.",
    image: "https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=1080&q=80",
    tags: ["Ergonomie", "Analyse du travail", "Activité", " Terminé"],
    category: "Analyse ergonomique",
    color: "orange",
    emoji: "🎬",
    details: {
      overview: "Capsule interactive conçue pour expliciter les principes ergonomiques en contexte professionnel.",
      features: [
  ...
  },
  {
    ...
    emoji: "",
    details: {
      overview: "Formalisation d'un protocole clair pour standardiser qualité d'accueil et fluidité opérationnelle.",
      features: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&w=1080&q=80",
    tags: ["CoI", "ADDIE", "Bloom", " Terminé"],
    category: "Conception e-learning",
    color: "purple",
    emoji: "",
    details: {
      overview: "Parcours Moodle structuré par modules, activités et évaluations pour soutenir la progression.",
      features: [
      ...
      architecture: ["CoI", "ADDIE", "Bloom"],
      challenges: ["Paramétrage pédagogique LMS", "Cohérence des activités"],
      outcome: " Terminé",
    },
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1588702547919-26089e690ecc?auto=format&fit=crop&w=1080&q=80",
    tags: ["CoI", "ADDIE", "Bloom", " Terminé"],
    category: "Conception e-learning",
    color: "green",
    emoji: "",
    details: {
      overview: "Organisation pédagogique d'une classe virtuelle avec planification, activités et communication continue.",
      features: [
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className={`max-w-xl mx-auto ${darkMode ? "text-gray-400" : "text-gray-500"}`}>
            Dispositifs construits autour du design instructionnel, des LMS et de la pédagogie active.
